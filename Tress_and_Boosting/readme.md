...
The first step implements a `DecisionTree` class with a `fit` and `predict` method.
This class is used as a base classifier and further used with random forests and boosting.
